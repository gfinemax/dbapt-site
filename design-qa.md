...
- Responsive comparison: each row keeps item and amount together, with date and source below; the narrow personal-library drawer has no vertical Korean text or horizontal overflow.
